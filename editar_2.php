<?php
    ...
    if(isset($_GET['id'])){
        $id=$_GET['id'];
        $query="SELECT * FROM rdiplomaticas_2 WHERE id=$id";
    ...
    if(isset($_POST['editar'])){
        ...
        $query="UPDATE rdiplomaticas_2 set nombre='$nombre', paisA='$paisA', paisB='$paisB', paisC='$paisC', descripcion='$descripcion' WHERE id=$id"; 
...
<body>
    ...
    <form action="editar.php?id=<?php echo $_GET['id']; ?> " method="POST">
            ...
            <input type="text" name="paisC" value="<?php echo $paisC ?>">
